...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#626262', '#b90000', '#ff8040', '#8080c0', '#ff5555', '#ff8080', '#a6a6a6', '#8080c0', '#ffff00','#00b058','#5757ae','#804000','#454545','#5f5faf','#00aa55','#750000']"
        dset background-color "'#1e1e1e'"
        dset foreground-color "'#808080'"
        dset bold-color "'#8080c0'"
...
gset string palette "#626262:#b90000:#ff8040:#8080c0:#ff5555:#ff8080:#a6a6a6:#8080c0:#ffff00:#00b058:#5757ae:#804000:#454545:#5f5faf:#00aa55:#750000"
gset string background_color "#1e1e1e"
gset string foreground_color "#808080"
gset string bold_color "#8080c0"
